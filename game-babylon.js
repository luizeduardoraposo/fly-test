...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Promise.all([
    BABYLON.SceneLoader.ImportMeshAsync("", "https://assets.babylonjs.com/meshes/", "spaceCraft.babylon", scene),
    BABYLON.SceneLoader.ImportMeshAsync("", "https://assets.babylonjs.com/meshes/", "rock.babylon", scene),
    BABYLON.SceneLoader.ImportMeshAsync("", "https://assets.babylonjs.com/meshes/", "building.babylon", scene),
    BABYLON.SceneLoader.ImportMeshAsync("", "https://assets.babylonjs.com/meshes/", "tree.babylon", scene)
  ]).then(function (results) {
    var shipAsset = results[0].meshes[0];
    var mountainAsset = results[1].meshes[0];
    var buildingAsset = results[2].meshes[0];
    var treeAsset = results[3].meshes[0];
